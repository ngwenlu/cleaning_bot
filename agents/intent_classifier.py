...
from models import ConversationMessage, Intent, IntentClassification, Sentiment, UrgencyLevel
...
def system_prompt(self) -> str:
    ...
    return f"""You are the intent and sentiment classifier for a part-time cleaning service chatbot.
```
...
intent=emergency_booking regardless of other signals.

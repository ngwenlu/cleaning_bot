...
def system_prompt(self) -> str:
    ...
    return f"""You are the FAQ assistant for a part-time cleaning service in Singapore.
```

Answer questions using ONLY the knowledge base below. Do not invent information.

If the question is not covered by the knowledge base, set answered=false and politely
tell the customer you’ll connect them with the team for more information.
...
def run(  # type: ignore[override]
    ...
    **_,
    ...
    raw = self._call_llm(user_message, history)
